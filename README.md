...
To interactively try out the F# NuGet package LunaZodiaco, go to the Jupyter Notebook [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Release-Candidate/LunaZodiaco/main?filepath=LunaZodiaco.ipynb)
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Release-Candidate/LunaZodiaco/main?filepath=LunaZodiaco.ipynb)
[more badges ...](#badges)
...
- [Installation and Usage](#installation-and-usage)
  ...
  - [LunaZodiaco NuGet Package](#lunazodiaco-nuget-package)
    ...
    - [Module LunaZodiaco](#module-lunazodiaco)
